...
class allocator_boundary_tags final : public smart_mem_resource,
   ...
   private:
	static constexpr const size_t allocator_metadata_size = sizeof(logger*) + sizeof(memory_resource*) +
	...
	void* allocate_in_hole(char* address, size_t size, void** first_block_ptr, void* prev_block, void* next_block,
	                       size_t size_free);
   ...
   public:
	explicit allocator_boundary_tags(
	    size_t space_size, std::pmr::memory_resource* parent_allocator = nullptr, logger* logger = nullptr,
