...
class binary_search_tree : private compare {
   ...
   public:
	explicit binary_search_tree(const compare& comp = compare(),
	                            pp_allocator<value_type> alloc = pp_allocator<value_type>(), logger* logger = nullptr);

	explicit binary_search_tree(pp_allocator<value_type> alloc, const compare& comp = compare(),
...
class bst_impl {
	...
	template <class... Args>
	static binary_search_tree<tkey, tvalue, compare, tag>::node* create_node(
...
template <typename tkey, typename tvalue, typename compare, typename tag>
void __detail::bst_impl<tkey, tvalue, compare, tag>::swap(
    binary_search_tree<tkey, tvalue, compare, tag>& lhs, binary_search_tree<tkey, tvalue, compare, tag>& rhs) noexcept {
	using std::swap;
...
explicit binary_search_tree(Range&& range, const compare& cmp = compare(), pp_allocator<U> alloc = pp_allocator<U>(),
                            logger* logger = nullptr)
    -> binary_search_tree<
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator::operator++() & noexcept {
	...
	if (_data->left_subtree) {
		...
		while (_data->parent && (!_data->parent->right_subtree || _data->parent->right_subtree == _data)) {
			_data = _data->parent;
		}

		_data = _data->parent ? _data->parent->right_subtree : nullptr;
	}
	return *this;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator::operator--() & noexcept {
	...
	if (_data->parent == nullptr) {
		_data = nullptr;
	} else if (_data->parent->left_subtree == _data) {
		_data = _data->parent;
	} else if (_data->parent->right_subtree == _data) {
		node* temp = _data->parent->left_subtree;
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_iterator::operator*() {
	if (!_data) {
		throw std::out_of_range("Trobles prefix_iterator::operator*");
	}
	return _data->data;
}
...
template <typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::prefix_reverse_iterator::operator binary_search_tree<
    tkey, tvalue, compare, tag>::prefix_iterator() const noexcept {
	auto copy = _base;
	++copy;
	return copy;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::prefix_const_reverse_iterator::prefix_const_reverse_iterator(
    const node* data, const node* backup)
    : _base(data, backup) {}
...
template <typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::prefix_const_reverse_iterator::operator binary_search_tree<
    tkey, tvalue, compare, tag>::prefix_const_iterator() const noexcept {
	auto copy = _base;
	++copy;
	return copy;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::infix_iterator::operator*() {
	if (!_data) {
		throw std::out_of_range("Trouble infix_iterator::operator*");
	}
	return _data->data;
}
...
template <typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::infix_reverse_iterator::operator binary_search_tree<
    tkey, tvalue, compare, tag>::infix_iterator() const noexcept {
	auto copy = _base;
	++copy;
	return copy;
}
...
template <typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::infix_const_reverse_iterator::operator binary_search_tree<
    tkey, tvalue, compare, tag>::infix_const_iterator() const noexcept {
	auto copy = _base;
	++copy;
	return copy;
}
...
binary_search_tree<tkey, tvalue, compare, tag>::postfix_iterator::operator++() & noexcept {
	...
	if (!_data->parent || _data == _data->parent->right_subtree || !_data->parent->right_subtree) {
		_data = _data->parent;
	} else {
...
binary_search_tree<tkey, tvalue, compare, tag>::postfix_iterator::operator--() & noexcept {
	...
	if (_data->right_subtree != nullptr) {
		...
		while (_data != _data->parent->right_subtree) {
			_data = _data->parent;
			_data->parent = _data->parent->parent;
		}
...
binary_search_tree<tkey, tvalue, compare, tag>::postfix_iterator::operator*() {
	if (!_data) {
		throw std::out_of_range("Trobles postfix_iterator::operator*");
	}
	return _data->data;
}
...
template <typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::postfix_reverse_iterator::operator binary_search_tree<
    tkey, tvalue, compare, tag>::postfix_iterator() const noexcept {
	auto copy = _base;
	++copy;
	return copy;
}
...
template <typename tkey, typename tvalue, compator<tkey> compare, typename tag>
binary_search_tree<tkey, tvalue, compare, tag>::postfix_const_reverse_iterator::operator binary_search_tree<
    tkey, tvalue, compare, tag>::postfix_const_iterator() const noexcept {
	auto copy = _base;
	++copy;
	return copy;
}
...
typename binary_search_tree<tkey, tvalue, compare, tag>::node* bst_impl<tkey, tvalue, compare, tag>::create_node(
    binary_search_tree<tkey, tvalue, compare, tag>& cont, Args&&... args) {
