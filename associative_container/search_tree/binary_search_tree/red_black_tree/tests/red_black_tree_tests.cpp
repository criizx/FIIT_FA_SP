...
bool compare_results(
    std::vector<typename binary_search_tree<int, std::string>::value_type>
        &expected,
    std::vector<typename binary_search_tree<int, std::string>::value_type>
        &actual) {
  ...
  for (auto &&val : boost::range::combine(expected, actual)) {
    if (get<0>(val).first != get<1>(val).first) {
      return false;
    }

    if (get<0>(val).second != get<1>(val).second) {
      return false;
    }
  }
...
template <typename tkey, typename tvalue> struct test_data {
  tkey key;
  tvalue value;
  size_t depth;
  red_black_tree<tkey, tvalue>::node_color color;

  test_data(size_t dep, tkey k, tvalue v,
            red_black_tree<tkey, tvalue>::node_color c)
      : depth(dep), key(k), value(v), color(c) {}
};
...
bool infix_iterator_test(
  ...
  for (; vec_begin != vec_end; ++vec_begin) {
    auto &item = *vec_begin;
    if (it.depth() != item.depth || it->first != item.key ||
        it->second != item.value || it.get_color() != item.color) {
      return false;
    }
...
TEST(redBlackTreePositiveTests, test1) {
  std::unique_ptr<logger> logger(
      create_logger(std::vector<std::pair<std::string, logger::severity>>{
          {"red_black_tree_tests_logs.txt", logger::severity::trace},
      }));

  logger->trace("redBlackTreePositiveTests.test1 started");

  auto rb = std::make_unique<red_black_tree<int, std::string>>(
      std::less<int>(), nullptr, logger.get());
  ...
  std::vector<test_data<int, std::string>> expected_result = {
      test_data<int, std::string>(
          2, 1, "l", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          1, 2, "b", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          2, 3, "d", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          0, 5, "a", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          2, 14, "e", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          1, 15, "c", red_black_tree<int, std::string>::node_color::BLACK)};
...
TEST(redBlackTreePositiveTests, test2) {
  ...
  auto rb = std::make_unique<red_black_tree<int, int>>(std::less<int>(),
                                                       nullptr, logger.get());
  ...
  std::vector<test_data<int, int>> expected_result = {
      test_data<int, int>(0, 2, 12,
                          red_black_tree<int, int>::node_color::BLACK),
      test_data<int, int>(1, 1, 5, red_black_tree<int, int>::node_color::BLACK),
      test_data<int, int>(1, 4, 45,
                          red_black_tree<int, int>::node_color::BLACK),
...
TEST(redBlackTreePositiveTests, test3) {
  ...
  auto rb = std::make_unique<red_black_tree<std::string, int>>(
      std::less<std::string>(), nullptr, logger.get());
  ...
  std::vector<test_data<std::string, int>> expected_result = {
      test_data<std::string, int>(
          1, "a", 1, red_black_tree<std::string, int>::node_color::BLACK),
      test_data<std::string, int>(
          2, "c", 15, red_black_tree<std::string, int>::node_color::RED),
      test_data<std::string, int>(
          2, "e", 4, red_black_tree<std::string, int>::node_color::RED),
      test_data<std::string, int>(
          1, "d", 3, red_black_tree<std::string, int>::node_color::BLACK),
      test_data<std::string, int>(
          0, "b", 2, red_black_tree<std::string, int>::node_color::BLACK)};
...
TEST(redBlackTreePositiveTests, test4) {
  ...
  auto rb1 = std::make_unique<red_black_tree<int, std::string>>(
      std::less<int>(), nullptr, logger.get());
  ...
  std::vector<test_data<int, std::string>> expected_result = {
      test_data<int, std::string>(
          2, 1, "i", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          1, 4, "j", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          3, 5, "b", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          2, 6, "a", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          0, 8, "c", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          1, 15, "x", red_black_tree<int, std::string>::node_color::BLACK)};
...
TEST(redBlackTreePositiveTests, test7) {
  ...
  std::vector<test_data<int, std::string>> expected_result = {
      test_data<int, std::string>(
          2, 2, "l", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          1, 4, "j", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          3, 5, "b", red_black_tree<int, std::string>::node_color::RED),
...
TEST(redBlackTreePositiveTests, test8) {
  ...
  std::vector<test_data<int, std::string>> expected_result = {
      test_data<int, std::string>(
          1, 6, "a", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          0, 8, "c", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          2, 11, "j", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          1, 12, "l", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          3, 17, "b", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          2, 18, "e", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          3, 19, "i", red_black_tree<int, std::string>::node_color::RED)};
...
TEST(redBlackTreePositiveTests, test9) {
  ...
  std::vector<test_data<int, std::string>> expected_result = {
      ...
      test_data<int, std::string>(
          0, 8, "c", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          2, 12, "l", red_black_tree<int, std::string>::node_color::BLACK),
      test_data<int, std::string>(
          1, 15, "x", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          3, 17, "b", red_black_tree<int, std::string>::node_color::RED),
      test_data<int, std::string>(
          2, 18, "e", red_black_tree<int, std::string>::node_color::BLACK),
...
TEST(redBlackTreePositiveTests, test11) {
  ...
  std::vector<typename red_black_tree<int, std::string>::value_type>
      actual_result(b, e);

  std::vector<typename red_black_tree<int, std::string>::value_type>
      expected_result = {{2, "e"}, {4, "b"}, {6, "l"}, {8, "c"}, {9, "h"}};
